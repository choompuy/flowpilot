...
export const Hero = () => {
  return (
    <section className="flex items-center min-h-[calc(100vh-72px)] py-20 overflow-hidden" id="hero">
      <div className="container grid max-xs:grid-rows-[auto_calc(35rem*.55)] max-sm:grid-rows-[auto_calc(35rem*.75)] max-lg:grid-rows-[auto_35rem] lg:grid-cols-[auto_minmax(40%,50rem)] items-center mx-auto gap-5 px-6">
        <div className="flex flex-col gap-5 z-10 opacity-0 animate-[fadeInUp_0.8s_ease_forwards]">
          ...
          <h1 className="text-5xl md:text-7xl leading-[1.05] font-bold text-text-primary">Manage your workflow with AI-powered automation</h1>
